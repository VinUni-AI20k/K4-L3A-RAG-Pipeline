...
CHÍNH SÁCH BẢO VỆ DỮ LIỆU CÁ NHÂN CỦA CÔNG TY CỔ PHẦN VINHOMES
PERSONAL DATA PROTECTION POLICY OF VINHOMES JOINT STOCK COMPANY

Chính Sách Bảo Vệ Dữ Liệu Cá Nhân (hay còn có tên gọi khác là Chính sách quyền riêng tư) này mô tả cách thức thu thập, sử dụng và xử lý Dữ Liệu Cá Nhân phát sinh trong quá trình hoạt động, kinh doanh của Công ty Cổ phần Vinhomes (sau đây gọi là “Công Ty”) có địa chỉ tại Tòa nhà văn phòng Symphony, Đường Chu Huy Mân, Khu đô thị Vinhomes Riverside, Phường Phúc Lợi, Quận Long Biên, Thành phố Hà Nội, Việt Nam và trang thông tin điện tử chính thức là vinhomes.vn.
This Personal Data Protection Policy (also known as the Privacy policy) describes how to collect, use and process personal data arising in the course of operation and business of Vinhomes Joint Stock Company (hereinafter referred to as the "Company") located in Symphony Office Building, Chu Huy Man Street, Vinhomes Riverside Urban Area, Phuc Loi Ward, Long Bien District, Hanoi City, Vietnam, and the official website is vinhomes.vn.
...
1.7       Chính sách này có thể được Công Ty cập nhật, sửa đổi, bổ sung hoặc thay thế để đảm bảo tuân thủ quy định của pháp luật trong từng thời kỳ và được Công Ty đăng tải trên trang thông tin điện tử chính thức của Công Ty. Quý vị nên truy cập và kiểm tra trang web thường xuyên để cập nhật những thay đổi gần nhất.

 

This Policy may be updated, modified, supplemented, or replaced by the Company from time to time to ensure compliance with applicable laws and regulations. Such updates will be published on the Company’s official website. You are advised to visit and check the website regularly to stay informed of the latest changes.
...
2.           PHẠM VI DỮ LIỆU CÁ NHÂN ĐƯỢC THU THẬP, XỬ LÝ SCOPE OF PERSONAL DATA COLLECTED AND PROCESSED
...
Các Dữ Liệu Cá Nhân được quy định trong hợp đồng/thỏa thuận với Chủ Thể Dữ Liệu Cá Nhân là cần thiết để thực hiện các cam kết giữa hai bên. Công Ty có thể cần thu thập, xử lý thêm các Dữ Liệu Cá Nhân liên quan nhằm đảm bảo thực hiện đầy đủ hợp đồng/thỏa thuận/nghĩa vụ của Công Ty đối với Chủ Thể Dữ Liệu Cá Nhân và tuân thủ quy định pháp luật. Trường hợp Chủ Thể Dữ Liệu Cá Nhân không đồng ý để Công Ty thu thập, xử lý một số dữ liệu cụ thể, Công Ty sẽ thông báo về các ảnh hưởng liên quan đến việc thực hiện hợp đồng/thỏa thuận nếu có.
  The Personal Data specified in the contract/agreement with the Data Subject is necessary for fulfilling the commitments between both parties. The Company may need to collect and process additional relevant Personal Data to ensure the full execution of the contract/agreement and compliance with legal regulations. In cases where the Data Subject does not consent to the collection or processing of certain specific data, The Company will inform the Data Subject of any potential impacts on the performance of the contract/agreement, if applicable.
...
3.1       Đánh giá khả năng cung cấp sản phẩm, dịch vụ hoặc/và giao kết hợp đồng với Chủ Thể Dữ Liệu Cá Nhân, bao gồm các mục đích sau:
Evaluating the capability to provide products, services and/or enter into contract with the Personal Data Subject, including to the purposes as follows:
...
3.2       Thực hiện các nghĩa vụ trong hợp đồng, thỏa thuận, điều khoản, điều kiện và các văn kiện khác giữa Công Ty và Chủ Thể Dữ Liệu Cá Nhân, hỗ trợ khách hàng bao gồm các mục đích sau: Fulfilling obligations in contracts, agreements, terms, conditions and other documents between the Company and the Personal Data Subject, supporting customers including to the purposes as follows:
...
3.3        Nâng cao chất lượng sản phẩm, dịch vụ của Công Ty bao gồm:
Improving the quality of the Company's products and services, including to:
...
(iii)      Quản lý tài khoản khách hàng và các chương trình khách hàng thân thiết do Tập đoàn Vingroup- Công ty CP và các công ty thành viên của Tập đoàn Vingroup- Công ty CP triển khai thực hiện;
Managing customer accounts and loyalty programs implemented by Vingroup Joint Stock Company and its member companies;
...
(viii)       Tiếp thị, quảng bá sản phẩm, dịch vụ trong đó bao gồm xây dựng các chiến dịch dựa trên sở thích của khách hàng;
Marketing, promoting products and services, including building campaigns based on customer preferences.


3.4       Phục vụ hoạt động kinh doanh, vận hành của Công Ty bao gồm việc thực hiện các nghĩa vụ về báo cáo, tài chính, kế toán và thuế, các hoạt động có mục đích kiểm toán, tuân thủ và các hoạt động khác phục vụ việc kinh doanh hợp pháp của Công Ty trong những trường hợp mà Công Ty cho là cần thiết.

 

Serving the Company's business and operation activities including to the fulfillment of reporting, financial, accounting and tax obligations, auditing, compliance activities and other activities serving the Company's legitimate business in cases that the Company deems necessary.
...
3.6        Tuân thủ quy định của pháp luật, điều ước quốc tế mà Việt Nam là thành viên bao gồm: Compliance with the provisions of law and international treaties to which Vietnam is a party, including to:
...
(iii)       Phòng, chống, ngăn ngừa, điều tra, phát hiện tội phạm.
Prevention, combating, investigation and detection of crimes.

(iv)        Bảo vệ trật tự an toàn xã hội, bảo vệ quyền và lợi ích hợp pháp của Chủ Thể Dữ Liệu Cá Nhân, Công Ty và các bên liên quan khác.
...
Công Ty chỉ xử lý Dữ Liệu Cá Nhân cho các mục đích cụ thể mà Chủ Thể Dữ Liệu Cá Nhân đã đồng ý.
The Company only processes Personal Data for specific purposes that the Personal Data Subject has consented to.

Các mục đích được nêu tại các mục 3.1, 3.2, 3.4, 3.5, 3.6 nêu trên là cần thiết để Công Ty thực hiện hoặc giao kết hợp đồng với Chủ Thể Dữ Liệu Cá Nhân, đồng thời bảo đảm tuân thủ quy định pháp luật và các thỏa thuận giữa các bên. Đối với các mục đích tại mục 3.3 việc Chủ Thể Dữ Liệu Cá

 

Nhân không đồng ý sẽ không ảnh hưởng đến hiệu lực hoặc việc thực hiện các hợp đồng/thỏa thuận giữa Công Ty và Chủ Thể Dữ Liệu Cá Nhân.

The purposes stated in Sections 3.1, 3.2, 3.4, 3.5, and 3.6 above are necessary for The Company to perform or enter into a contract with the Personal Data Subject, while also ensuring compliance with legal regulations and agreements between the parties. For the purposes stated in Section 3.3, the Personal Data Subject’s refusal to consent will not affect the validity or performance of any contracts/agreements between the Company and the Personal Data Subject.

4.           CÁCH THỨC XỬ LÝ DỮ LIỆU CÁ NHÂN
METHODS OF PERSONAL DATA PROCESSING
4.1        Cách thức thu thập Collection methods
...
From communications with the Personal Data Subject: Personal Data is collected through interaction between the Company and the Personal Data Subject (in-person meeting, by mail, telephone, online, call center system, electronic communication or any other means) including surveys.
...
(vii)     Các phương tiện khác Other means
...
4.2       Cách thức lưu trữ Storage methods
...
4.6       Cách thức xóa dữ liệu Data deletion methods
...
6.1        Công Ty sử dụng nhiều công nghệ bảo mật thông tin khác nhau như hệ thống tường lửa, các biện pháp kiểm soát truy cập, mã hóa,… nhằm bảo vệ và ngăn chặn việc Dữ Liệu Cá Nhân bị truy cập, sử dụng hoặc chia sẻ trái phép. Tuy nhiên, trong một số tình huống ngoài khả năng kiểm soát của Công Ty, việc bảo đảm an toàn tuyệt đối cho Dữ Liệu Cá Nhân là không thể, và có thể dẫn đến các hậu quả sau:
The Company uses various information security technologies such as firewalls, access control measures, encryption, etc., to protect and prevent Personal Data from being accessed, used, or disclosed without authorization. However, in certain situations beyond The Company's control, it is not possible to ensure absolute security of Personal Data, which may result in the following consequences:

(i)          Mất dữ liệu do lỗi phần cứng, phần mềm trong quá trình xử lý dữ liệu;
Data loss due to hardware or software failures during data processing,

(ii)        Lộ lọt dữ liệu do lỗ hổng bảo mật nằm ngoài khả năng kiểm soát của Công Ty, hệ thống bị hacker tấn công.
Data breaches caused by security vulnerabilities beyond the Company’s control or system attacks by hackers leading to data exposure or leakage.

Dữ liệu bị mất mát/lộ lọt có thể bị sử dụng để thực hiện hành vi gian lận, lừa đảo, hoặc gây tổn thất tài chính cho Chủ Thể Dữ Liệu Cá Nhân. Ngoài ra, việc lộ thông tin nhạy cảm có thể ảnh

 

hưởng tiêu cực đến danh tiếng, đời sống cá nhân hoặc công việc của Chủ Thể Dữ Liệu Cá Nhân.

Lost/leaked data may be used to commit fraud, scams, or cause financial loss to the Personal Data Subject. Additionally, the disclosure of sensitive information may negatively affect the reputation, personal life, or professional career of the Personal Data Subject.

6.2        Công Ty khuyến cáo:
The Company recommends:

(i)           Chủ Thể Dữ Liệu Cá Nhân bảo mật các thông tin liên quan đến mật khẩu đăng nhập vào tài khoản, mã OTP và không chia sẻ nội dung này với bất kỳ người nào khác.
...
(ii)         Chủ Thể Dữ Liệu Cá Nhân cần biết rõ rằng bất kỳ thời điểm nào khi Chủ Thể Dữ Liệu Cá Nhân tiết lộ và công khai Dữ Liệu Cá Nhân của mình, dữ liệu đó có thể bị người khác thu thập và sử dụng cho các mục đích nằm ngoài tầm kiểm soát của Chủ Thể Dữ Liệu Cá Nhân và Công Ty.
...
(iii)      Công Ty khuyến cáo Chủ Thể Dữ Liệu Cá Nhân bảo quản thiết bị cá nhân (máy điện thoại, máy tính bảng, máy tính cá nhân…) trong quá trình sử dụng. Chủ Thể Dữ Liệu Cá Nhân nên đăng xuất khỏi tài khoản của mình khi không sử dụng.
...
(iv)      Khi truyền tải Dữ Liệu Cá Nhân qua không gian mạng, Chủ Thể Dữ Liệu Cá Nhân chỉ nên sử dụng các hệ thống an toàn để truy cập trang thông tin điện tử, ứng dụng hoặc thiết bị. Chủ Thể Dữ Liệu Cá Nhân có trách nhiệm giữ thông tin xác thực truy cập của mình cho từng trang thông tin điện tử, ứng dụng hoặc thiết bị an toàn và bí mật.
When transmitting Personal Data over cyberspace, the Personal Data Subject should only use secure systems to access the website, application or device. The Personal Data Subject is responsible for keeping his/her access credentials for each website, application or device secure and confidential.

6.3       Trách nhiệm của Công Ty trong trường hợp xảy ra hậu quả, thiệt hại không mong muốn
Responsibility of the Company in the event of unintended consequences or damages

Trong phạm vi pháp luật cho phép, Công Ty cam kết thực hiện các trách nhiệm sau đây nhằm giảm thiểu rủi ro và bảo vệ quyền lợi của Chủ Thể Dữ Liệu Cá Nhân:
To the extent permitted by law, the Company is committed to undertaking the following responsibilities to mitigate risks and protect the rights of the Personal Data Subject:


 

(i)         Chủ động ứng phó và khắc phục: Ngay khi phát hiện sự cố liên quan đến mất mát hoặc rò rỉ Dữ Liệu Cá Nhân, Công Ty sẽ triển khai ngay các biện pháp kỹ thuật và tổ chức cần thiết để ngăn chặn, khắc phục hậu quả, hạn chế thiệt hại và thông báo tới Chủ Thể Dữ Liệu Cá Nhân theo quy định của pháp luật.
Proactive response and remediation: Upon detecting any incident involving the loss or leakage of Personal Data, the Company will promptly implement necessary technical and organizational measures to prevent further breaches, mitigate consequences, minimize damages, and notify the Personal Data Subject in accordance with applicable laws.


(ii)       Hợp tác với cơ quan chức năng: Công Ty sẽ phối hợp chặt chẽ với các cơ quan chức năng có thẩm quyền để điều tra, xử lý sự cố và thực hiện các nghĩa vụ báo cáo theo quy định của pháp luật.
Cooperation with authorities: The Company will closely cooperate with competent authorities to investigate and address the incident and fulfill all legal reporting obligations.

(iii)     Khắc phục thiệt hại: Trong trường hợp có thiệt hại thực tế phát sinh do lỗi từ phía Công Ty, Công Ty sẽ xem xét thực hiện các trách nhiệm với Chủ Thể Dữ Liệu Cá Nhân theo quy định pháp luật hiện hành.
Compensation for damages: In cases where actual damages arise due to the Company's fault, the Company will consider fulfilling its responsibilities to the Personal Data Subject in accordance with applicable laws.

(iv)      Rà soát và cải tiến: Sau mỗi sự cố, Công Ty sẽ tiến hành đánh giá nguyên nhân, rà soát hệ thống và cập nhật các biện pháp bảo mật để ngăn ngừa sự cố tương tự trong tương lai. Review and improvement: After each incident, the Company will assess the root causes, review its systems, and update security measures to prevent similar incidents in the
...
7.1        Dữ Liệu Cá Nhân được xử lý kể từ thời điểm Công Ty nhận được Dữ Liệu Cá Nhân một cách hợp pháp và Công Ty đã có cơ sở pháp lý phù hợp để xử lý dữ liệu theo quy định pháp luật. Personal Data is processed from the moment the Company lawfully receives the Personal Data and the Company has an appropriate legal basis for processing the data in accordance with the provisions of law.

7.2        Dữ Liệu Cá Nhân sẽ được xử lý cho đến khi các mục đích xử lý dữ liệu đã được hoàn thành. Personal Data will be processed until the purposes of the data processing have been completed.
...
8.           TỔ CHỨC, CÁ NHÂN THAM GIA QUÁ TRÌNH XỬ LÝ DỮ LIỆU CÁ NHÂN VÀ PHẠM VI SỬ DỤNG DỮ LIỆU CÁ NHÂN
ORGANIZATIONS AND INDIVIDUALS PARTICIPATING IN THE PROCESSING OF PERSONAL DATA AND SCOPE OF PERSONAL DATA USAGE
...
(ii)        Tổ chức, cá nhân cung cấp dịch vụ và/hoặc hợp tác với Công Ty, bao gồm: đại lý, kiểm toán, luật sư, các đối tác hợp tác kinh doanh, cung cấp giải pháp công nghệ thông tin, phần mềm, ứng dụng, các dịch vụ vận hành, quản lý, xử lý sự cố, phát triển hạ tầng;
Organizations, individuals providing services and/or cooperating with the Company, including to: agents, auditors, lawyers, business partners, partners providing information technology solutions, software, applications, operation, management, troubleshooting services, etc. infrastructure development;
...
9.9       Right to object to data processing.
...
To provide complete and accurate Personal Data when giving consent to Personal Data Processing. If there is any false information, the Personal Data Subject shall bear the costs incurred in the event that such information affects or restricts the rights of the Personal Data Subject.
