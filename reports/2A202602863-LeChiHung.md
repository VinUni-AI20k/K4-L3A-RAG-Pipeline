...
- Test hoặc query tôi đã dùng: `pytest -q` (36 passed); `python -m src.task9_retrieval_pipeline --calibrate` với 6 query in-domain + 6 out-of-domain; `python -m src.task11_evaluation` trên 20 câu golden cho cả A và B.
