...
**Tránh đụng nhau:** `group_project/evaluation/experiments.md` là file dùng
chung — **thêm dòng vào bảng**, đừng ghi đè bảng của người khác.
...
1. **Contextual chunking** — prepend tiêu đề tài liệu vào nội dung từng chunk,
   ...
   - Lưu ý: thí nghiệm ngược lại (bỏ bớt text mang tiêu đề) đã đo và cho kết quả
     **tệ hơn** 0.218 điểm — xem `experiments.md`. Giả thuyết này vì thế khá chắc.
...
dòng vào `experiments.md` với số liệu thật, và số câu bị từ chối giảm xuống dưới
...
**Xong khi:** cả hai tính năng chạy được, `experiments.md` có số liệu A/B cho
